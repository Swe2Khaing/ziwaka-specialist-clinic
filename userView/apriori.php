...
$data_item = array(
    ...
    array("id" => 7, "item" => "Respiratory failure, severe pneumonitis, COPD, IHD"),
    array("id" => 8, "item" => "PUO, DM"),
    array("id" => 9, "item" => "old stroke, IHD, Psychosis"),
    array("id" => 10, "item" => "COPD, IHD, Severe pneumontis"),
