...
$restable = mysqli_query($conn,"SELECT * FROM inpatient");
...
<body>
    ...
    <section class="dashboard">
        <div class="top ">
            ...
            <div class="col-12">
					<a href="#" class="btn  btn-block m-1" style="border-radius:0%;background-color:#f8ecf2;" data-toggle="modal" data-target="#insertPatient"><i class="fa fa-users"></i> Patient Register </a>
				</div>
...
<table class="table table-responsive aaa " id="aaa"> 
  <thead>
    <tr>
...
while($row=mysqli_fetch_array($restable))
  ...
  <td>
<?php
echo "<a class='btn bg-danger btn-sm' style='color:white' href='patientDetail.php?pid=".$row['InP_ID']."'>Detail</a></span>&nbsp; ";   
 ?>
  </td>
</tr>
<?php } ?>
    ...
    <div class="modal fade" id="insertPatient">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <select name="ac" id="ac" style="margin-top:20px;">
                    <option value="">Select Age Category</option>
                    <option value="day">day</option>
                    <option value="month">month</option>
                    <option value="year">year</option>
                </select><br>
                <input type="radio" id="male" name="gender" value="male" required style="margin-top:5px;">
                <label for="male">male</label>
                <input type="radio" id="female" name="gender" value="female" required>
                <label for="female">female</label><br>
                <input type="tel" id="phone" name="phone" placeholder="09-12345-6789" pattern="[0-9]{2}[0-9]{5}[0-9]{4}"  ><br>
                <input type="text" id="querter" name="querter" style="margin-top:5px;"><br>
                <input type="text" id="village" name="village" style="margin-top:5px;"><br>
                <input type="text" id="city" name="city"style="margin-top:5px;"><br>
                <select name="doctor" id="doctor" style="border: 1px solid #5cd65c;color:black;">
            ...
            <?php 
                                           ...
                                           while($rowd = mysqli_fetch_array($res))
                                              { ?>
                <option value="<?php echo $rowd['Do_ID']; ?>"> <?php echo $rowd['Do_Name']; ?> </option>
                <?php } ?>
            </select>
                <input type="text" id="admdx" name="admdx"  style="margin-top:5px;"><br>
                <input type="text" id="dcdx" name="dcdx"  style="margin-top:5px;"><br>
                <input type="date" id="dc-date" name="dc-date" style="margin-top:5px;"><br>
                <input type="date" id="death-date" name="death-date" style="margin-top:5px;"><br>
                <input type="time" id="death-time" name="death-time" style="margin-top:5px;"><br>
            </div>
        </div>
        <div class="row aa" style="display:flex;justify-content:center;">
         
        
            <button class="btn btn-success" type="submit" name="submit" style="margin:10px;width:100%;background: linear-gradient(#31B7C2,#02b23d);">Save</button>
